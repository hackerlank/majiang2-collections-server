...
public class LoginModelServiceImpl extends BaseService implements LoginModelService {
    ...
    private void setLoginTimeAttribute(Object session, long currentTimeMillis) {
        Session.setAttribute(session, "loginTime", currentTimeMillis);
    }

    private void setRoleIdAttribute(Object session, Object value) {
        Session.setAttribute(session, "roleId", value);
    }
     ...
     */
    private void setMacAttribute(Object session, LoginInfo loginInfo) {
        String macAddress = loginInfo.getMacAddress();
        if (macAddress == null) {
            return;
        }
        Session.setAttribute(session, "mac", macAddress);
    }
     ...
     * @author wcy 2017年10月20日
     */
    private String getMacAttribute(Object session) {
        Object value = Session.getAttribute(session, "mac");
