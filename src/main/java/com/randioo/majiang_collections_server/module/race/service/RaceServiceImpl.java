package com.randioo.majiang_collections_server.module.race.service;
...
import com.randioo.majiang_collections_server.entity.po.MahjongRaceConfigure;
import com.randioo.majiang_collections_server.entity.po.Race;
import com.randioo.majiang_collections_server.entity.po.RaceRole;
import com.randioo.majiang_collections_server.entity.po.RaceStateInfo;
...
@BaseServiceAnnotation("raceService")
@Service("raceService")
public class RaceServiceImpl extends ObserveBaseService implements RaceService {
    ...
    private GameConfigData parseGameConfig(MahjongRaceConfigure configure) {
        GameConfigData gameConfig = GameConfigData.newBuilder()
                .setRaceType(configure.raceType)
                .setBaseScore(configure.minStartScore)
                .setMaxCount(configure.maxCount)
                .setGangScore(configure.gangScore)
                .setFlyScore(configure.catchScore)
                .setFlyCount(configure.endCatchCount)
                .setEndTime(configure.endTime)
                .build();
    ...
    public void joinRace(Role role, int raceId) {
        ...
        SessionUtils.sc(role.getRoleId(), SC.newBuilder()
                .setRaceJoinRaceResponse(RaceJoinRaceResponse.newBuilder())
                .build());
