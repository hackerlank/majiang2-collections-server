...
public class MatchServiceImpl extends ObserveBaseService implements MatchService {
    ...
    public void createRoom(Role role, GameConfigData gameConfigData) {
        ...
        processor.push(game, ICommandCallback.WAIT);
    ...
    public void joinGame(Role role, String lockString) {
        ...
        synchronized (game) {
            ...
            List<Integer> cards = game.rule.getCards();
            List<Integer> flowers = game.rule.getFlowers();
    ...
    private String getIp(int roleId) {
        ...
        try {
            Object ioSession = SessionCache.getSessionById(roleId);
            if (ioSession == null) {
                return "";
            }

            InetSocketAddress address = getSocketAddress(ioSession);
            if (address == null) {
                return "";
            }
     ...
     * @param session
     * @return
     * @author wcy 2017年11月27日
     */
    private InetSocketAddress getSocketAddress(Object session) {
