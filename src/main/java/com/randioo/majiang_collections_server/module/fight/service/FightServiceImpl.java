...
import com.randioo.mahjong_public_server.protocol.Entity.CallTingData;
...
import com.randioo.mahjong_public_server.protocol.Fight.FightPreTingResponse;
...
import com.randioo.mahjong_public_server.protocol.Fight.FightSendTingCardResponse;
import com.randioo.mahjong_public_server.protocol.Fight.FightTingCheckResultResponse;
...
import com.randioo.majiang_collections_server.entity.po.AIChooseCallCardListTimeEvent;
import com.randioo.majiang_collections_server.entity.po.AISendCardTimeEvent;
...
import com.randioo.majiang_collections_server.module.fight.component.CreateBaiDaCard;
import com.randioo.majiang_collections_server.module.fight.component.FillFlower;
import com.randioo.majiang_collections_server.module.fight.component.GameSeat;
...
import com.randioo.majiang_collections_server.module.fight.component.VoteTimeEvent;
import com.randioo.majiang_collections_server.module.fight.component.WaitOtherCallCardListChecker;
import com.randioo.majiang_collections_server.module.fight.component.ZhuangJudger;
...
import com.randioo.majiang_collections_server.module.fight.component.processor.MajiangProcessor;
import com.randioo.majiang_collections_server.module.fight.component.rule.BaidaMajiangRule;
import com.randioo.majiang_collections_server.module.fight.component.rule.HongZhongMajiangRule;
import com.randioo.majiang_collections_server.module.fight.component.rule.QiaoMaRule;
...
public class FightServiceImpl extends ObserveBaseService implements FightService {
    ...
    @Autowired
    private MajiangProcessor processor;

    @Autowired
    private GameSeat gameSeat;

    @Autowired
    private RoleGameInfoManager roleGameInfoGetter;
    ...
    private boolean checkVoteExitAllOffline(Game game, int applyRoleId) {
        ...
        for (RoleGameInfo roleInfo : game.getRoleIdMap().values()) {
            ...
            if (roleInfo.roleId != applyRoleId) {
                ...
                if (session == null || !Session.isConnected(session) && result == null) {
                    agreeExitCount++;
                }
            }
        }
    ...
    private void ifAIAutoSendCard(int gameId, int seat) {
        Game game = this.getGameById(gameId);
        RoleGameInfo nextRoleGameInfo = this.current(game);
            ...
            if (GlobleMap.Boolean(GlobleConstant.ARGS_ARTIFICIAL)) {
                ...
                AISendCardTimeEvent evt = new AISendCardTimeEvent() {
                    ...
                    public void update(TimeEvent timeEvent) {
                        ...
                        if (game == null)
                            return;
                        RoleGameInfo roleGameInfo = current(game);
    ...
    private void newCardAdd2Cards(Game game, RoleGameInfo roleGameInfo) {
        ...
        int baidaCard = game.rule.getBaidaCard(game);
    ...
    @Override
    public void gmEnvVars(String roomId, List<EnvVarsData> list, Object session) {
        ...
        Session.write(session, SC.newBuilder().setGmEnvVarsResponse(response).build());

    }

    @Override
    public void gmGameInfo(String roomId, Object session) {
        Integer gameId = GameCache.getGameLockStringMap().get(roomId);
        if (gameId == null) {
            SC sc = SC.newBuilder()
    ...
    @Override
    public void gmDispatchCard(String roomId, List<ClientCard> list, List<Integer> remainCards, Object session,
    ...
    public static void main(String[] args) {
        ...
        MajiangProcessor processor = SpringContext.getBean(MajiangProcessor.class);
