...
public interface FightService extends ObserveBaseServiceInterface {
     ...
     */
    void gmEnvVars(String roomId, List<EnvVarsData> list, Object session);

    void gmGameInfo(String roomId, Object session);
     ...
     * @author wcy 2017年9月5日
     */
    void gmDispatchCard(String roomId, List<ClientCard> list, List<Integer> remainCards, Object session,
